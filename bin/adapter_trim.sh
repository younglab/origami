...
cutadapt -n 3 -m 17 --overlap 10 -a forward="ACGCGATATCTTATCTGACT" -a reverse="AGTCAGATAAGATATCGCGT" -o $OUTDIR/l_t1.fq --untrimmed-output $OUTDIR/l_nt1.fq -p $OUTDIR/r_t1.fq --untrimmed-paired-output $OUTDIR/r_nt1.fq $OUTDIR/left_reads.fq $OUTDIR/right_reads.fq
